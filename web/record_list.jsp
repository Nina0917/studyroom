                                                ...
                                                <table width="60%"  class="cont tr_color">
                                                    ...
                                                    <c:forEach items="${records}" var="r">
                                                        <tr align="center" class="d">
                                                            ...
                                                            <td>${r.date}</td>
                                                            <%--<td>
                                                                <a onclick="return confirm('确认取消预约');" href="appointment.let?type=cancel&id=${app.id}">预约</a>
                                                                &lt;%&ndash;<a onclick="return confirm('确认删除');" href="type.let?type=remove&id=${t.id}">删除</a>&ndash;%&gt;
                                                            </td>--%>
                                                        </tr>
                                                    </c:forEach>
                                                </table>
